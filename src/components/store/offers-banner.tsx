...
const MESSAGE =
  'ന്തൊക്കെ ണ്ട് വിശേഷം , സുഖല്ലേ ? .. സൈറ്റിൽ ഒരു വിധം സാനം ഒക്കെ ണ്ട് .. സൈസ് തെറ്റി ഓർഡർ ആകരുത് ട്ടോ .. ശ്രെദ്ദികൊണ്ടു .. ഒക്കെ താങ്ക്യൂ .. ചോദ്യങ്ങളൊക്കെ  അജുനോട് വട്സാപ്പില് ചോയ്ക്കലോ  ..';
